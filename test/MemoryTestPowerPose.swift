...
struct MemoryTestPowerPose: View {
    var name: String
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationDestination(isPresented: $shouldNavigate) {
                MemoryTestView2(name: name, firstScore: firstScore, math: math, math2: math2, reaction: reaction, reaction2: reaction2, number: number, number2: number2, mathPP: mathPP, reactionPP: reactionPP, numberPP: numberPP, memoryPP: (isHighPowerPose ? "High Power Pose" : "Low Power Pose"))
