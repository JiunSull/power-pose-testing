                ...
                VStack {
                    if !isTestFinished {
                        ...
                        .fullScreenCover(isPresented: $shouldNavigate, content: {
                            TestView(name: name, math: firstScore, math2: String(score), reaction: reaction, reaction2: reaction2, memory: memory, memory2: memory2, number: number, number2: number2, mathPP: mathPP, reactionPP: reactionPP, memoryPP: memoryPP, numberPP: numberPP)
                        })
                    }}
            }
            .padding()
