...
struct NumberPractice: View {
    ...
    @State private var positions = [CGPoint](repeating: .zero, count: 20)
            ...
            if showCongratulations {
                VStack {
                    ...
                    .fullScreenCover(isPresented: $shouldNavigate, content: {
                        NumberTestView(name: name, math: math, math2: math2, reaction: reaction, reaction2: reaction2, memory: memory, memory2: memory2, mathPP: mathPP, reactionPP: reactionPP, memoryPP: memoryPP)
                    })
                }
            } else {
                    ...
                    ForEach(numbers, id: \.self) { number in
                        NumberView(number: number, position: positions[number - 1], currentNumber: $currentNumber, showCongratulations: $showCongratulations, startTime: $startTime, endTime: $endTime, numbers: $numbers)
                    }
