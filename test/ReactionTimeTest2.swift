        ...
        VStack {
            if showCompletionScreen {
                ...
                .fullScreenCover(isPresented: $shouldNavigate, content: {
                    TestView(name: name, math: math, math2: math2, reaction: firstScore + " sec", reaction2: String(format: "%.3f", averageReactionTime()) + " sec", memory: memory, memory2: memory2, number: number, number2: number2, mathPP: mathPP, reactionPP: reactionPP, memoryPP: memoryPP, numberPP: numberPP)
                })
            } else {
