        ...
        VStack {
            if memorizing {
                ...
                .fullScreenCover(isPresented: $shouldNavigate, content: {
                    TestView(name: name, math: math, math2: math2, reaction: reaction, reaction2: reaction2, memory: firstScore, memory2: String(score), number: number, number2: number2, mathPP: mathPP, reactionPP: reactionPP, memoryPP: memoryPP, numberPP: numberPP)
                })
            } else {
