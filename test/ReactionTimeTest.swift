        ...
        VStack {
            if showCompletionScreen {
                ...
                .fullScreenCover(isPresented: $shouldNavigate, content: {
                    ReactionTimeTestPowerPose(name: name, firstScore: String(format: "%.3f", averageReactionTime()), math: math, math2: math2, memory: memory, memory2: memory2, number: number, number2: number2,  mathPP: mathPP, memoryPP: memoryPP, numberPP: numberPP, isHighPowerPose: true)
                })
                Button(action: {
                ...
                .fullScreenCover(isPresented: $shouldNavigate2, content: {
                    ReactionTimeTestPowerPose(name: name, firstScore: String(format: "%.3f", averageReactionTime()), math: math, math2: math2, memory: memory, memory2: memory2, number: number, number2: number2,  mathPP: mathPP, memoryPP: memoryPP, numberPP: numberPP, isHighPowerPose: false)
                })
            } else {
