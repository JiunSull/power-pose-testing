...
struct NumberTestPowerPoseView: View {
    var name: String
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationDestination(isPresented: $shouldNavigate) {
                NumberTestView2(name: name, firstScore: firstScore, math: math, math2: math2, reaction: reaction, reaction2: reaction2, memory: memory, memory2: memory2, mathPP: mathPP, reactionPP: reactionPP, memoryPP: memoryPP, numberPP: (isHighPowerPose ? "High Power Pose" : "Low Power Pose"))
